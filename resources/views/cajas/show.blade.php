<x-app-layout>
            ...
            <div class="flex flex-col">
                <div class="flex flex-col gap-10">
                    ...
                    <div class="dark:text-gray-500">
                        <a href="{{ route('showDetalle.cajas', ['sesionCaja' => $ultimaSesion->id]) }}" class="bg-gray-300 text-gray-800 p-2 rounded">Ver más</a>
                    </div>
                </div>
            </div>
    ...
    <!-- Modal -->
    <div id="confirmarCerrarCajaModal"
        ...
        <div class="bg-white rounded-lg p-8 w-1/3">
            ...
            <div class="flex justify-end gap-10">
                <form action="{{ route('cerrar.caja') }}" method="POST">
                    @csrf
                    <button type="submit" class="bg-gray-500 text-white px-4 py-2 rounded-md cursor-pointer">Confirmar
                        Cerrar Caja</button>
                </form>
                <button id="cancelarCerrarCaja"
                    class="bg-blue-300 text-gray-800 px-4 py-2 rounded-md mr-2">Cancelar</button>
            </div>
        </div>
    </div>
</x-app-layout>
