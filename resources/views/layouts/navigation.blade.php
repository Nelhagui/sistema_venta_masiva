<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('index.productos')" :active="request()->routeIs(['index.productos', 'index.productosBase', 'create.productos', 'create.productosStock'])">
                        {{ __('Productos') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('index.ventas')" :active="request()->routeIs('index.ventas')">
                        {{ __('Ventas') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('index.lector')" :active="request()->routeIs('index.lector')">
                {{ __('Lector') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('index.productos')" :active="request()->routeIs('index.productos')">
                {{ __('Catálogo de productos') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('index.clientes')" :active="request()->routeIs('index.clientes')">
                {{ __('Clientes') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('index.ventas')" :active="request()->routeIs('index.ventas')">
                {{ __('Ventas') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('show.cajas')" :active="request()->routeIs(['show.cajas', 'index.cajas', 'create.cajaIngreso'])">
                {{ __('Caja') }}
            </x-responsive-nav-link>
        </div>
