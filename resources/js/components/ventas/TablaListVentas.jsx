                ...
                <table className='min-w-full h-auto table-auto w-full' >
                    <thead className='[&>tr]:first:rounded-lg' style={{ textAlign: 'start' }}>
                        <tr className='group outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2' style={{ textAlign: 'start' }}>
                            ...
                            <th style={{ backgroundColor: '#999cbe', fontWeight: 'bold', color: 'white', }} className='group px-3 h-10 whitespace-nowrap text-foreground-500 text-tiny font-semibold first:rounded-l-lg last:rounded-r-lg'>AUMENTO</th>
                            <th style={{ backgroundColor: '#999cbe', fontWeight: 'bold', color: 'white', }} className='group px-3 h-10 whitespace-nowrap text-foreground-500 text-tiny font-semibold first:rounded-l-lg last:rounded-r-lg'>DESCUENTO</th>
