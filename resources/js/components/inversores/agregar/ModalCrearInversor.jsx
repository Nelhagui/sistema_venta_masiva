...
export default function ModalCrearInversor() {
        ...
        <>
            ...
            >
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader className="flex flex-col gap-1">Nuevo Inversor</ModalHeader>
                            <ModalBody>
                                <Input
                                ...
                                />
                                <Input
                                    isRequired={camposObligatorios.includes('apellido')}
                                    label="Apellido"
                                    ...
                                    value={data.apellido}
                                    onChange={onChangeValue}
                                    isInvalid={msjError?.apellido ?? false}
                                    errorMessage={msjError?.apellido ?? ''}
                                />
                                <Input
                                    label="Telefono"
