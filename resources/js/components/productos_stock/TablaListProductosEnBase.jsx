...
const TablaListProductosEnBase = () => {
                        ...
                        objetosBuscados.length > 0
                            ? (
                                objetosBuscados.map((producto) => (
                                    <li key={Math.random()} style={styles.containerRowProducto} className='border-t border-b' onClick={() => { addProducto(producto) }}>
                                    ...
                                    >
                                        <option value="">Seleccione un proveedor</option>
                                        {
                                            proveedores.map((proveedor) => {
                                                return <option value={proveedor.id} key={Math.random()}>{proveedor.nombre}</option>
                                            })
                                        }
                                    </select>
...
export default TablaListProductosEnBase